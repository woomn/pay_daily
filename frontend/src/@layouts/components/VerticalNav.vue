  ...
  >
    ...
    <div class="nav-header">
      <slot name="nav-header">
        ...
        <Component
          :is="layoutConfig.app.iconRenderer || 'div'" v-show="configStore.isVerticalNavCollapsed"
        ...
        />
        <Component
          :is="layoutConfig.app.iconRenderer || 'div'" class="header-action d-lg-none"
    ...
    <slot name="nav-items" :update-is-vertical-nav-scrolled="updateIsVerticalNavScrolled">
      <PerfectScrollbar
        :key="configStore.isAppRTL" tag="ul" class="nav-items" :options="{ wheelPropagation: false }"
